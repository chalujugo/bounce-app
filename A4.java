	...
	* @return toolsPanel		the Panel */
	    ...
	    public void valueChanged(TreeSelectionEvent e) {
	        ...
	        if(obj != null) {
	            if(obj instanceof NestedShape) {
	                TableModelAdapter model = panel.getTableModelAdapter();
	                model.setNestedShape((NestedShape)obj);
	            }
	        }
	    }
	}
	...
	class RemoveNodeActionListener implements ActionListener {
	    ...
	    public void actionPerformed(ActionEvent e) {
	        ...
	        if(selectedPath != null) {
	            Object obj = selectedPath.getLastPathComponent();
	            if(obj != tree.getModel().getRoot()) {
	                panel.removeShape(selectedPath);
	            } else {
	...
	class TreeModelAdapter implements TreeModel {
	    ...
	    public void addToRoot(Shape s){
	        ...
	        NestedShape rt = ((NestedShape)nestedShape).getParent();
	        rt.add((NestedShape)s.getParent());
	        
	        int[] childIndices = {size+1};
	        Object[] children = {s};
	        Object[] rt_path = {rt};
	        
	        fireTreeNodesInserted(this, rt_path, childIndices, children);
	    }
